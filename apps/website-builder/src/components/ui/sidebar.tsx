    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ? "p-2 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4)_+_theme(spacing.4))]"
            : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=right]:rotate-180",
          className
        )}
        {...props}
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-lg"
        >
          {children}
        </div>
      </div>
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("rounded-md h-8 flex gap-2 px-2 py-2", className)}
      {...props}
    >
      {showIcon && (
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "inline-flex h-4 min-w-4 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground select-none",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
