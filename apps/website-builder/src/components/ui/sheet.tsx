...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      ...
      "sheet-overlay", // Add specific class for CSS targeting
      className
    )}
    style={{ zIndex: UI_Z_INDEX.SHEET_OVERLAY }}
    {...props}
    ref={ref}
  />
));
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(sheetVariants({ side }), "sheet-content", className)} // Add specific class for CSS targeting
      style={{ zIndex: UI_Z_INDEX.SHEET_CONTENT }}
      {...props}
    >
      {children}
