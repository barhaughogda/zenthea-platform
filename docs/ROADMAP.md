...
| **MIG-04A** | Migration | Clinical Documentation (Draft Only, HITL) | **Completed** | `docs/12-migration/mig-04A/` *(Phase 3 complete – deterministic core implemented)* |
| **MIG-04B** | Migration | Clinical Documentation (Write Paths & Attestation) | **Blocked (Explicit Stop Condition)** | `docs/12-migration/mig-04B-clinical-documentation-commit.md` |
